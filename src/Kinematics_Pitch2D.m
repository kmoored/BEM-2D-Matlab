function [xp,zp,Vp] = Kinematics_Pitch2D(xp,zp,alpha_max,f,t,phi,D)
...
z_n = (xpt - xpt(1))*sin(alpha_max*sin(2*pi*f*t + phi));
...
v1(2,:) = (xplus - xpt(1))*sin(alpha_max*sin(2*pi*f*t + phi));

v2(1,:) = (xminus - xpt(1))*cos(alpha_max*sin(2*pi*f*t + phi));
v2(2,:) = (xminus - xpt(1))*sin(alpha_max*sin(2*pi*f*t + phi));
...
z_np = (xpt - xpt(1))*sin(alpha_max*sin(2*pi*f*t_plus + phi));

% Calculating positions of four points around position of neutral
% plane for a time t_plus
v1(1,:) = (xplus - xpt(1))*cos(alpha_max*sin(2*pi*f*t_plus + phi));
v1(2,:) = (xplus - xpt(1))*sin(alpha_max*sin(2*pi*f*t_plus + phi));

v2(1,:) = (xminus - xpt(1))*cos(alpha_max*sin(2*pi*f*t_plus + phi));
v2(2,:) = (xminus - xpt(1))*sin(alpha_max*sin(2*pi*f*t_plus + phi));
...
z_nm = (xpt - xpt(1))*sin(alpha_max*sin(2*pi*f*t_minus + phi));


% Calculating positions of four points around position of neutral
% plane for a time t_minus
v1(1,:) = (xplus - xpt(1))*cos(alpha_max*sin(2*pi*f*t_minus + phi));
v1(2,:) = (xplus - xpt(1))*sin(alpha_max*sin(2*pi*f*t_minus + phi));

v2(1,:) = (xminus - xpt(1))*cos(alpha_max*sin(2*pi*f*t_minus + phi));
v2(2,:) = (xminus - xpt(1))*sin(alpha_max*sin(2*pi*f*t_minus + phi));
