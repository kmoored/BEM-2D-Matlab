...
% c = 0.12;
tmax = 0.001*c;               % Cylinder diameter, meters.
...
%         '_f',num2str(f)];
    ...
    save(['Theodorsen/Parameters',savefilename,'.mat'],'-v7.3')

    fid_Data = fopen(['Theodorsen/Data',savefilename,'.txt'],'w');
    fid_PanelProp = fopen(['Theodorsen/PanelProp',savefilename,'.txt'],'w');
    fid_WakeProp = fopen(['Theodorsen/WakeProp',savefilename,'.txt'],'w');
end
