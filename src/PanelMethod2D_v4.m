...
% function [Ct_avg,Tnet_avg,D_avg,Cl_avg,Cpow_avg,np,Ec,f,A_TE,rho,c,Qinf] = PanelMethod2D_v4(d_c,St,A_c,Re,Npanels,Nstep,Ncyc,Nlump,TEfac,val)
% Npanels
% Nstep
% Ncyc
% Nlump
