...
%% Loading data 
load(['FlowfieldData/Parameters',savefilename,'.mat']);       
Data = load(['FlowfieldData/Data',savefilename,'.txt']);
PanelProp = load(['FlowfieldData/PanelProp',savefilename,'.txt']);
WakeProp = load(['FlowfieldData/WakeProp',savefilename,'.txt']);
...
save(['FlowfieldData/ProcessedData',savefilename,'.mat'],'-v7.3') 
