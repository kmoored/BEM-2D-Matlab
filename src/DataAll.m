...
hold on
plot(St(1:end-1), Ct_pm_250, 'r-','LineWidth', 1.5, 'MarkerSize', 5);
plot(St(1:end-1), Ct_pm_500, 'b-','LineWidth', 1.5, 'MarkerSize', 5);
plot(St(1:end-1), Ct_pm_inf, 'k-','LineWidth', 1.5, 'MarkerSize', 5);
errorbar(St, Ct_250,Ct_250_std,'ro','MarkerSize', 6, 'LineWidth', 1.5);
errorbar(St, Ct_500,Ct_500_std,'bo','MarkerSize', 6, 'LineWidth', 1.5);
errorbar(St, Ct_inf,Ct_250_std,'ko','MarkerSize', 6, 'LineWidth', 1.5);
