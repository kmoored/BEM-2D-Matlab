...
%% Loading data 
load(['FixedV/Valid_Parameters',savefilename,'.mat']);
Data = load(['FixedV/Valid_Data',savefilename,'.txt']);
PanelProp = load(['FixedV/Valid_PanelProp',savefilename,'.txt']);
WakeProp = load(['FixedV/Valid_WakeProp',savefilename,'.txt']);
