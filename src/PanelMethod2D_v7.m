...
% function [Ct_avg,Tnet_avg,D_avg,Cl_avg,Cpow_avg,Pow_avg,np,Ec,f,A_TE,rho,c,Ucruise,V_t] = PanelMethod2D_v7(A_bp,M_star,f,A_c,c,Qinf,d_c,Npanels,Nstep,Ncyc,Nlump,TEfac,val)
% Npanels
% Nstep
% Ncyc
% Nlump
