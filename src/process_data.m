function process_data(folder,savefilename)


%% Loading data 
load([folder,'/Parameters',savefilename,'.mat']);       
Data = load([folder,'/Data',savefilename,'.txt']);
PanelProp = load([folder,'/PanelProp',savefilename,'.txt']);
WakeProp = load([folder,'/WakeProp',savefilename,'.txt']);
